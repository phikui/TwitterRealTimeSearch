...
public class QueueContainer {
    private static final Queue<PreprocessingRawObject> rawObjectQueue = new LinkedBlockingQueue<PreprocessingRawObject>();
    private static final Queue<Future<TransportObject>> preprocessedOutput = new LinkedBlockingQueue<Future<TransportObject>>();
